...
<div>
  <bar></bar>
    ...
    <v-menu  :close-on-content-click="false" :nudge-width="200" offset-x transition="scroll-y-transition"
      max-width="500"
      height="430">
      <template v-slot:activator="{ on, attrs }">
          ...
          class="mr-16 mt-8 d-flex flex-row-reverse">
            <v-img  src="../assets/filter-filled-tool-symbol.png" max-height="35" max-width="35" color="#C50000" ></v-img>
          </div>
      </template>
